...
Transformation of raw viewing logs into a transactional format for association mining.

Association Mining: 

Utilization of the apyori library to extract rules based on Support, Confidence, and Lift metrics.

Visualization: 

Generation of analytical charts to highlight the top-performing movie associations.
